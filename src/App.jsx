          ...
          filteredData.map(item => (
            <div key={item.id} className="group flex flex-col xl:flex-row items-center gap-6 md:gap-8 p-4 border border-[var(--border)] bg-[var(--bg-secondary)] transition-all duration-500 hover:border-[var(--accent)]/40">
              ...
              <div className="w-full xl:w-[220px] xl:border-l border-[var(--border)] xl:pl-8 flex flex-col justify-center gap-4">
                <div className="flex flex-row xl:flex-col justify-between items-center xl:items-end px-2 xl:px-0 font-sans text-[var(--text-main)]">
                ...
                <button 
                  ...
                  className={`w-full py-4 text-[10px] font-black uppercase tracking-[0.2em] transition-all border ${
                    purchasedIds.includes(item.id) ? 'border-[var(--border)] bg-[var(--bg-primary)] opacity-50 cursor-default text-[var(--text-main)]' : 'bg-[var(--accent)] text-white border-[var(--accent)] active:scale-95'
                  }`}
                >
...
function Profile({ purchasedIds, data }) {
  ...
  return (
    <div className="min-h-screen py-12 md:py-24 max-w-6xl mx-auto font-sans">
      <h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter italic mb-10 border-b border-[var(--border)] pb-10 text-center md:text-left text-[var(--text-main)]">Библиотека.</h1>
    ...
    <div className="max-w-5xl mx-auto py-16 md:py-24 px-6 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
        {[
          ...
          <div key={i} className="space-y-6 p-8 border border-[var(--border)] bg-[var(--bg-secondary)] rounded-sm text-[var(--text-main)]">
